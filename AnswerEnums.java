...
public enum AnswerEnums implements Serializable {
	...
	P1_QC_ANSWER1("P1_QC_ANSWER1", "P1_QC", "Novell, the password I use to access my computer first thing in the morning.<span class=\"hidden\">P1_QC_ANSWER1</span>", true),
	...
	P1_QD_ANSWER1("P1_QD_ANSWER1", "P1_QD", "No. I report it to the Help Desk.<span class=\"hidden\">P1_QD_ANSWER1</span>", false),
	P1_QD_ANSWER2("P1_QD_ANSWER2", "P1_QD", "No. Novell contact the Help Desk. Oracle can be reset via online.<span class=\"hidden\">P1_QD_ANSWER2</span>", true),
	...
	P3_QC_ANSWER1("P3_QC_ANSWER1", "P3_QC", "No. BOE is designed to view all reports without users having Crystal Report License.<span class=\"hidden\">P3_QC_ANSWER1</span>", true),
	P3_QC_ANSWER2("P3_QC_ANSWER2", "P3_QC", "Yes. Everyone get Crystal Reports as normal software provided to each user.<span class=\"hidden\">P3_QC_ANSWER2</span>", false),
	P3_QC_ANSWER3("P3_QC_ANSWER3", "P3_QC", "Yes. BOE doesn’t work if you don’t have Crystal Report License.<span class=\"hidden\">P3_QC_ANSWER3</span>", false),
	P3_QC_ANSWER4("P3_QC_ANSWER4", "P3_QC", "Yes. Crystal Reports is automatically installed on my computer.<span class=\"hidden\">P3_QC_ANSWER4</span>", false),
	P3_QC_ANSWER5("P3_QC_ANSWER5", "P3_QC", "Yes. I have to submit a CARF to get Crystal Report License.<span class=\"hidden\">P3_QC_ANSWER5</span>", false),
	P3_QC_ANSWER6("P3_QC_ANSWER6", "P3_QC", "Only managers have Crystal Report License.<span class=\"hidden\">P3_QC_ANSWER6</span>", false),
